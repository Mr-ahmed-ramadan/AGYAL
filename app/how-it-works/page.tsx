        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mb-12">
          <Card className="flex flex-col">
            ...
            <CardContent className="flex-grow">
              <p>
                Explore a wide range of fixed income opportunities. Our advanced search algorithm helps you find fixed
                income opportunities that match your criteria.
              </p>
            </CardContent>
          </Card>
          <Card className="flex flex-col">
          ...
          <Card className="flex flex-col">
            ...
            <CardContent className="flex-grow">
              <p>
                Secure your assets with confidence using our DLT-powered self-custody solution. Your assets are secured
                by cutting-edge blockchain technology, giving you full control.
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-6 space-y-2">
                <li>Access a diverse range of fixed income opportunities</li>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Access real-time data on your offerings</li>
              </ul>
            </CardContent>
          </Card>
        </div>
