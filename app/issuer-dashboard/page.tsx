      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <Tabs defaultValue="profile" className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="listings">Current Offerings</TabsTrigger>
            <TabsTrigger value="new-listing">New Offering</TabsTrigger>
          ...
          <TabsContent value="listings">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your current bond offerings</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="new-listing">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Add a new bond or fixed income offering to your listings</CardDescription>
              </CardHeader>
              <CardContent>
                <form className="space-y-4">
                  <div className="grid gap-2">
                    <Label htmlFor="type">Type of Offering</Label>
                    <Select>
                  ...
                  <div className="grid gap-2">
                    ...
                    <Input id="minPurchase" type="number" placeholder="Enter minimum purchase amount" />
                  </div>
                  <div className="grid gap-2">
                    <Label htmlFor="description">Description</Label>
                    <Textarea id="description" placeholder="Enter a description of the offering" />
                  </div>
                  <div className="grid gap-2">
